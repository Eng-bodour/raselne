...
class StoreListBuild extends StatefulWidget {
  const StoreListBuild({Key? key}) : super(key: key);
...
class _StoreListBuildState extends State<StoreListBuild> {
  ...
  void initState() {
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      await Provider.of<StoreProvider_vm>(context, listen: false).getstores();
    });
    super.initState();
  }
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            buildText(
                                                title: value.liststore[index]
                                                    .nameStore, //'برجر كنج',
                                                content: value.liststore[index]
