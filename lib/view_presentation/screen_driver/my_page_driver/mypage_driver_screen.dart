        ...
        child: Directionality(
          ...
          child: Padding(
            ...
            child: ModalProgressHUD(
              inAsyncCall: Provider.of<AuthProvider_vm>(context,
                  listen: true)
              .isloading,
              child: Column(
                children: [
                  ...
                  accountBalance(
                      ...
                      size: size,
                      title: 'رصيد الحساب',
                      count: '  ${user.balance}  رس '):Container(),
                  Divider(
                    thickness: 1,
                    color: greyColor.withOpacity(0.2),
                  ),
                ...
                info(
                  ...
                  info(
                      ...
                      icon: const Icon(Icons.notes_outlined,
                          color: Colors.black26)),
                user.type=='user'?
                Divider(thickness: 1, color: greyColor.withOpacity(0.2)):Container(),
                  user.type=='user'?
                  info(
                      ontap: () {},
                      context: context,
